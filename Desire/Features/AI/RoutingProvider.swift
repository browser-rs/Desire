...
///
/// The sticky flag lives on `AIPreferenceStore.routingLockedToCloud`
...
struct RoutingProvider: ModelProvider {
    ...
    private func decide(messages: [AIMessage], tools: [AIToolDef]) -> ModelProviderKind {
